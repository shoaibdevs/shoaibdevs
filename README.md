...
- 🏗️ Experienced in owning projects end-to-end — backend architecture, API design, and frontend integration
- 🛒 Background spans ERPs, marketplaces, and service platforms
